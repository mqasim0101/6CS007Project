...
//session_start();
     ...
     //include("index.php"); // to check for user login:
     include("search_form.php"); // to allow search to continue;
?>
...
<html>
    ...
    <body>
        ...
        <div class="container my-5">
            ...
            <!-- Buttons below: -->
            <button><a href="add_articles_form.php">Add Articles</a></button>
            <button><a href="edit_articles_form.php">Modify Articles</a></button>
            <button><a href="delete_articles_form.php">Delete Articles</a></button>
            <br><br>
    </body>
</html>